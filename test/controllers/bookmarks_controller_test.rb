...
class BookmarksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bookmark" do
    assert_difference("Bookmark.count") do
      post bookmarks_url, params: { bookmark: { add_date: @bookmark.add_date, desc: @bookmark.desc, href: @bookmark.href } }
    end
  ...
  test "should update bookmark" do
    patch bookmark_url(@bookmark), params: { bookmark: { add_date: @bookmark.add_date, desc: @bookmark.desc, href: @bookmark.href } }
